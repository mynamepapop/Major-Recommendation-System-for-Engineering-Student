            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="am_email" placeholder="Enter email">
                    </div>
                    <div class="form-group">
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <nav class="navbar p-0" id="main_Content">
                <!--ส่วน haeder ใน เมนู 2-->
                <div class="row haeder_navbar">
                    <div class="col m-auto pl-2">ตารางการจัดการผู้ดูแลระบบ</div>
                     <!--ส่วน search_text-->
                    <div class="col-3 m-auto p-2 text-righ">
                        <div class="input-group">
                            <input type="text" name="search_text" id="search_text" class="form-control" placeholder="Search Admin ID" aria-label="ค้นหา Admin ID" aria-describedby="basic-addon2">
                     ...
                     <!--ส่วน search_text-->
                    <div class="col-auto m-auto p-1 text-righ">
                        <button type="submit" class="btn bg-primary text-white " onclick="location.reload();"><i class="fas fa-sync-alt"></i> Refresh</button>
                    </div>
                     <!--ปุ่มเพิ่มข้อมูล-->
                    <div class="col-auto m-0 p-2 text-right ">
                        <button type="submit" class="btn bg-success text-white add-new"><i class="fa fa-plus"></i> Add New</button>
                    </div>
                </div>
                <!--table-->
                    ...
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                ...
                                <th scope="col">ประจําภาควิชา</th>
                                <th scope="col">ระดับผู้ใช้งาน</th>
                                <th scope="col">Email</th>
                                <th scope="col" style="width:120px">จัดการข้อมูล</th>
                            </tr>
                        </thead>
                        <tbody id="show_select_data">
                            <?php
                                include "php/ajax_show_select_data_admin.php";
                            ?>
                            <tr>
                                <td>116482120</td>
                                <td>ศาสตราจารย์</td>
                                ...
                                <td>1</td>
                                <td>rmutt@gmail.com</td>
                                <td>
                                    <a class="add"  data-toggle="tooltip"><i class="fas fa-user-plus fa-lg text-success"></i></a>
                                    <a class="edit"  data-toggle="tooltip"><i class="fas fa-pencil-alt fa-lg text-warning"></i></a>
                                    <a class="delete" data-toggle="tooltip"><i class="fas fa-trash fa-lg text-danger"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
